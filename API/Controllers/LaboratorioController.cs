...
public class LaboratorioController : BaseApiController
{
    ...
    {
        var entidad = await unitofwork.Laboratorios.Consulta2A();
    ...
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<Pager<object>>> Consulta2APag([FromQuery] Params paisParams)
    {
        var entidad = await unitofwork.Laboratorios.Consulta2A(paisParams.PageIndex, paisParams.PageSize, paisParams.Search);
