...
public class ProveedorController : BaseApiController
{
    ...
    {
        var entidad = await unitofwork.Proveedores.Consulta4B();
    ...
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<Pager<object>>> Consulta4BPag([FromQuery] Params paisParams)
    {
        var entidad = await unitofwork.Proveedores.Consulta4B(paisParams.PageIndex, paisParams.PageSize, paisParams.Search);
