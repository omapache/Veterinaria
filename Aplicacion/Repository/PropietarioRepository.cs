...
public class PropietarioRepository : GenericRepo<Propietario>, IPropietario
{
    ...
    public virtual async Task<(int totalRegistros,object registros)> Consulta4A(int pageIndez, int pageSize, string search)
    {
        var query = 
    ...
    public virtual async Task<(int totalRegistros,object registros)> Consulta5B(int pageIndez, int pageSize, string search)
    {
        var query = 
        from p in _context.Propietarios
        select new
